...
ActiveRecord::Schema.define(version: 20150819021137) do
  ...
  add_index "invoicedetails", ["product_id"], name: "index_invoicedetails_on_product_id"
  ...
  create_table "testboots", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
